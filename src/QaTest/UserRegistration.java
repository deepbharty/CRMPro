...
//Now filling the registration form
	...
	driver.findElement(By.xpath("//*[@name='email']")).sendKeys("Deepbharty13@yopmail.com");
	
	driver.findElement(By.xpath("//*[@name='email_confirm']")).sendKeys("Deepbharty13@yopmail.com");
	
	driver.findElement(By.xpath("//*[@name='username']")).sendKeys("Deepbharty13");
...
driver.findElement(By.xpath("//*[@name='city']")).sendKeys("Gautambuddhnagar");
	...
	driver.findElement(By.name("email")).sendKeys("Swatibharty2@yopmail.com");
	
	driver.findElement(By.name("email_confirm")).sendKeys("Swatibharty2@yopmail.com");
	
	driver.findElement(By.name("username")).sendKeys("Swatibharty2");
